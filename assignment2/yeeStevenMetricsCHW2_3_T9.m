...
rmse_pols(irho)  =  sqrt(se_pols(irho)^2+bias_pols(irho)^2);
	...
	if rho(irho) == 0.7;
        ...
        saveas(gcf,'metricsCPS2graph15.png');
        %hold off;
        ...
        orient landscape;
        print('-depsc2', ['histogram' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
        saveas(gcf,'metricsCPS2graphs16.png');
        %hold off;
        ...
        orient landscape;
        print('-depsc2', ['histogram' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
        saveas(gcf,'metricsCPS2graphs17.png');
        %hold off;
        ...
        orient landscape;
        print('-depsc2', ['histogram' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
        saveas(gcf,'metricsCPS2graphs18.png');
        %hold off;
    end;
...
saveas(gcf,'metricsCPS2graphs19.png');
...
orient landscape;
print('-depsc2', ['bias_se_rmse' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
saveas(gcf,'metricsCPS2graphs20.png');
...
orient landscape;
print('-depsc2', ['bias_se_rmse' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
saveas(gcf,'metricsCPS2graphs21.png');
