...
rmse_pols(irho)  =  sqrt(se_pols(irho)^2+bias_pols(irho)^2);
	...
	if rho(irho) == 0.7;
        ...
        saveas(gcf,'metricsCPS2graph8.png');
        %hold off;
        ...
        orient landscape;
        print('-depsc2', ['histogram' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
        saveas(gcf,'metricsCPS2graphs9.png');
        %hold off;
        ...
        orient landscape;
        print('-depsc2', ['histogram' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
        saveas(gcf,'metricsCPS2graphs10.png');
        %hold off;
        ...
        orient landscape;
        print('-depsc2', ['histogram' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
        saveas(gcf,'metricsCPS2graphs11.png');
        %hold off;
    end;
...
saveas(gcf,'metricsCPS2graphs12.png');
...
orient landscape;
print('-depsc2', ['bias_se_rmse' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
saveas(gcf,'metricsCPS2graphs13.png');
...
orient landscape;
print('-depsc2', ['bias_se_rmse' '_N_' num2str(N) '_T_' num2str(T) '.eps']);
saveas(gcf,'metricsCPS2graphs14.png');
